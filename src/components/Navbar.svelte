...
<div class="navbar bg-slate-800 ">
  ...
  <div class="navbar-center">
    <a href="/" class="btn btn-ghost normal-case text-xl text-white">daisyUI</a>
  </div>
  <div class="navbar-end text-white">
    {#if searchform}
    <input type="search" name="search" id="search-form" class="px-2 py-1 rounded-md focus:outline-dotted outline-indigo-500 text-slate-900" placeholder="Search Movie..." in:fly={{ y: 50, duration: 500 }} out:fly={{ y: -50, duration: 500 }} />
    {/if}
